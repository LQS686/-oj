...
export default function LoginPage() {
 ...
 <span className="transition-transform duration-300">登录</span>
 )}
 </button>
 </form>
 ...
 <span className="transition-transform duration-300">立即注册</span>
 </Link>
 </div>

 <div className="mt-8 p-5 rounded-xl bg-primary/5 border border-primary/10 hover:border-primary/20 transition-all duration-300">
 ...
 <span>管理员:</span>
 <code className="bg-muted px-3 py-1.5 rounded-lg border border-border font-mono text-foreground text-xs hover:border-primary/30 transition-colors duration-300">admin / admin123</code>
 </p>
 <p className="flex flex-wrap items-center justify-between gap-2">
 <span>普通用户:</span>
 <code className="bg-muted px-3 py-1.5 rounded-lg border border-border font-mono text-foreground text-xs hover:border-primary/30 transition-colors duration-300">user1 / user123</code>
 </p>
 </div>
 </div>
 </div>
