    ...
    <GuestAuthShell subtitle="欢迎回来，继续你的编程之旅">
      <div className="card-static p-5 md:p-8 shadow-2xl transition-all duration-300 animate-modal-in">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-page-title text-foreground">登录</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="login-username" className="block text-label text-foreground mb-3">
              用户名或邮箱
            </label>
          ...
          <div>
            <label htmlFor="login-password" className="block text-label text-foreground mb-3">
              密码
            </label>
            <div className="relative">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link
              ...
              className="text-sm text-primary-light hover:text-primary font-medium transition-colors duration-200 group"
            >
