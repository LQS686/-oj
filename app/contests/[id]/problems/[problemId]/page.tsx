...
export default function ContestProblemDetailPage({ params }: { params: Promise<{ id: string, problemId: string }> }) {
 ...
 <div className="card-static rounded-lg p-6">
 ...
 <div className="card-static rounded-xl p-4 text-center">
 ...
 <div className="card-static rounded-xl p-4 text-center col-span-2 sm:col-span-1">
 <button
 ...
 >
 <div className="card-static rounded-lg overflow-hidden sticky top-6">
 ...
 className="w-full h-[500px] rounded-xl bg-muted text-foreground font-mono text-sm p-4 border border-border hover:border-primary/30 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 resize-y transition-colors duration-300"
 spellCheck={false}
