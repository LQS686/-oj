        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div className="glass p-5 rounded-xl transition-all">
                    ...
                    {searchResults.map(problem => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="font-mono text-muted-foreground bg-muted/50 px-2 py-0.5 rounded text-sm group-hover:bg-primary/10 group-hover:text-primary-light transition-colors">
                    ...
                    {contestProblems.map((problem, index) => (
                      <div key={problem.id} className="p-4 flex items-center justify-between hover:bg-primary/5 transition-colors group">
                        <div className="flex items-center gap-4">
                          <span className="w-8 h-8 flex items-center justify-center bg-muted/50 text-muted-foreground rounded-lg text-sm font-bold group-hover:bg-primary/10 group-hover:text-primary-light transition-colors">
