    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground section-title">提交记录</h1>
            <p className="text-muted-foreground mt-1">查看所有代码提交和评测结果</p>
          </div>
        </div>
              ...
              {selectedSubmission.code && (
                <div className="mb-6">
                  ...
                  <div className="bg-background-secondary rounded-lg overflow-hidden border border-border">
                    <div className="px-4 py-2 bg-muted/50 text-muted-foreground text-sm border-b border-border">
