  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 py-8 relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-secondary/10 rounded-full blur-[150px] animate-pulse-slow"></div>
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[120px] animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-strong rounded-3xl p-6 md:p-10 shadow-2xl shadow-secondary/10 hover:shadow-secondary/20 transition-all duration-300 animate-fadeIn">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-secondary to-secondary-dark flex items-center justify-center shadow-lg shadow-secondary/30 animate-pulse-slow">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input pl-12 py-3 hover:border-primary/30 transition-colors duration-300"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input pl-12 pr-12 py-3 hover:border-primary/30 transition-colors duration-300"
                  placeholder="至少6位密码"
                  required
                />
                <button
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors duration-300 group"
                >
                  {showConfirmPassword ? <EyeOff className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" /> : <Eye className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />}
                </button>
              </div>
              {formData.confirmPassword && (
                <div className="mt-2 flex items-center gap-1.5 text-xs">
                  {formData.password === formData.confirmPassword ? (
                    <>
                      <CheckCircle2 className="w-4 h-4 text-secondary-light animate-pulse-slow" />
            ...
            <div className="flex flex-wrap items-start gap-2.5">
              ...
              <label className="text-sm text-muted-foreground">
                我已阅读并同意
                <Link href="/terms" className="text-primary-light hover:text-primary mx-1 transition-colors duration-300 group">
                  <span className="group-hover:underline">服务条款</span>
                </Link>
                和
                <Link href="/privacy" className="text-primary-light hover:text-primary mx-1 transition-colors duration-300 group">
            ...
            >
              {loading ? (
                ...
                <span className="group-hover:scale-105 transition-transform duration-300">注册</span>
              )}
            </button>
          </form>
          ...
          <div className="mt-8 text-center">
            ...
            <Link href="/login" className="text-primary-light hover:text-primary font-bold ml-1.5 transition-colors duration-300 group">
              <span className="group-hover:scale-105 transition-transform duration-300">立即登录</span>
            </Link>
          </div>
        </div>
      </div>
