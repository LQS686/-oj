...
export default function RegisterPage() {
 ...
 <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-secondary/10 rounded-full"></div>
 <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full" style={{ animationDelay: '2s' }}></div>
 </div>
 ...
 <div className="relative w-14 h-14 bg-primary rounded-lg flex items-center justify-center shadow-xl transition-transform duration-300">
 ...
 <div className="card-static rounded-lg p-6 md:p-10 shadow-2xl transition-all duration-300 animate-fadeIn">
 ...
 >
 {showPassword ? <EyeOff className="w-5 h-5 transition-transform duration-300" /> : <Eye className="w-5 h-5 transition-transform duration-300" />}
 </button>
 </div>
 {formData.password && (
 <div className="mt-3">
 ...
 className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors duration-300 group"
 >
 {showConfirmPassword ? <EyeOff className="w-5 h-5 transition-transform duration-300" /> : <Eye className="w-5 h-5 transition-transform duration-300" />}
 </button>
 </div>
 ...
 <span className="transition-transform duration-300">注册</span>
 )}
 </button>
 </form>
 ...
 <span className="transition-transform duration-300">立即登录</span>
 </Link>
 </div>
 </div>
 </div>
