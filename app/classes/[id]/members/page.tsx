...
import { Users, Activity, Search, UserPlus, Crown, Trash2 } from 'lucide-react'
...
export default function ClassMembersPage() {
 ...
 if (loading) {
 return <PageLoading label="加载成员中..." />
 }
 ...
 className="px-3 py-2.5 rounded-lg border border-border bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors"
 >
 ...
 actions={
 isAdmin ? (
 <Link href={`/classes/${classId}/invites`} className="btn btn-primary">
 ...
 className="text-sm px-2 py-1 rounded-md border border-border bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 cursor-pointer"
 >
 <option value="assistant">管理员</option>
 <option value="student">成员</option>
 </select>
