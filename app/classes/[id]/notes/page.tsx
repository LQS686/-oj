    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-2 text-sm mb-6">
          ...
          <span className="text-foreground font-medium">班级笔记</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">班级笔记</h1>
        ...
        {filteredNotes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredNotes.map((note) => (
              <NoteCard key={note.id} note={note} classId={classId} />
            ))}
          </div>
        )}
      </div>
...
function NoteCard({ note, classId }: { note: Note; classId: string }) {
