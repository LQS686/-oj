          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-muted/30 border border-border rounded-lg text-sm text-foreground"
          ...
          <div className="max-h-96 overflow-y-auto space-y-1">
            {filteredProblems.length === 0 ? (
              ...
              return (
                <label
                  key={p.id}
                  className="flex items-center gap-3 px-3 py-2 rounded hover:bg-muted/30 cursor-pointer"
                >
                  <input
                    type="checkbox"
                    checked={checked}
