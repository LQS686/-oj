  ...
  return (
    <div className="min-h-screen pb-8">
      <div className="container mx-auto px-4 pt-6 max-w-5xl">
        ...
        {/* 标题与写题解按钮 */}
        <div className="card-static rounded-2xl p-6 md:p-8 mb-6">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center shadow-lg shadow-primary/30 flex-shrink-0">
        ...
        {permissionLoading && (
          <div className="space-y-4" aria-busy="true" aria-live="polite">
            {[0, 1, 2].map((i) => (
              <div
                key={i}
                className="card-static rounded-2xl p-5 flex gap-4 animate-pulse"
              >
        ...
        {!permissionLoading && permission && !permission.allowed && (
          <div className="card-static rounded-2xl p-10 text-center animate-fadeIn">
