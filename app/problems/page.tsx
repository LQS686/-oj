...
export default function ProblemsPage() {
  ...
  if (loading) {
    return <PageLoading label="加载题目中..." />
  }
  ...
  return (
    ...
    >
        {filteredProblems.length === 0 ? (
          <div className="card-static rounded-lg p-12 text-center">
      ...
      {tagModalOpen && (
        ...
        >
          <div
            className="bg-background rounded-xl shadow-xl w-full max-w-lg max-h-[85vh] flex flex-col border border-border"
