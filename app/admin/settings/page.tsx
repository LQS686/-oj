...
export default function AdminSettingsPage() {
  ...
  const [testResult, setTestResult] = useState<{ type: 'success' | 'error'; msg: string } | null>(
    null
  )
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card p-5">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-section-title text-foreground">网站设置</h2>
          </div>

          <div className="space-y-4">
            <div>
              <label className="block text-label text-muted-foreground mb-2">网站名称</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">网站描述</label>
              <textarea
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">默认编程语言</label>
              <select
                value={
                  ['cpp', 'c', 'python'].includes(settings.defaultLanguage)
        ...
        <div className="card p-5">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-section-title text-foreground">权限设置</h2>
          </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-white/5">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, allowGuestSubmission: e.target.checked })
                  }
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary/50 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
        ...
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-section-title text-foreground">评测设置</h2>
          </div>
          <p className="text-xs text-muted-foreground mb-6">
            保存后立即热更新当前进程的评测队列。若 .env / Docker 中显式设置了同名 JUDGE_*
            环境变量，环境变量优先。
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateJudge('jobTimeout', Math.round(numOr(e.target.value, judge.jobTimeout)))
                }
                className="input"
              />
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">Fail-fast</label>
              <select
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">跨提交并发</label>
              <input
                type="number"
                min={1}
                max={16}
                ...
                onChange={(e) =>
                  updateJudge(
                    'maxConcurrent',
                    Math.round(numOr(e.target.value, judge.maxConcurrent))
                  )
                }
                className="input"
              />
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">测点并行度</label>
              <input
                type="number"
                min={0}
                max={16}
                ...
                onChange={(e) =>
                  updateJudge(
                    'caseConcurrency',
                    Math.round(numOr(e.target.value, judge.caseConcurrency))
                  )
                }
                className="input"
              />
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">大测点并行度</label>
              <input
                type="number"
                min={1}
                max={8}
                ...
                onChange={(e) =>
                  updateJudge(
                    ...
                    Math.round(numOr(e.target.value, judge.largeCaseConcurrency))
                  )
                }
                className="input"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateJudge('rejudgeTimes', Math.round(numOr(e.target.value, judge.rejudgeTimes)))
                }
                className="input"
              />
            </div>
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">超时容差比例</label>
              <input
                type="number"
                min={0}
                max={1}
                ...
                onChange={(e) =>
                  updateJudge('extraTimeRatio', numOr(e.target.value, judge.extraTimeRatio))
                }
                className="input"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateJudge(
                    'compileTimeout',
                    Math.round(numOr(e.target.value, judge.compileTimeout))
                  )
                }
                className="input"
              />
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 rounded-lg bg-white/5">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateJudge(
                      'ioSlackMaxMs',
                      Math.round(numOr(e.target.value, judge.ioSlackMaxMs))
                    )
                  }
                  className="input"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateJudge('deadCheckMs', Math.round(numOr(e.target.value, judge.deadCheckMs)))
                  }
                  className="input"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateJudge(
                      'closeFallbackMs',
                      Math.round(numOr(e.target.value, judge.closeFallbackMs))
                    )
                  }
                  className="input"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateJudge(
                      'largeCaseBytes',
                      Math.round(numOr(e.target.value, judge.largeCaseBytes))
                    )
                  }
                  className="input"
                />
        ...
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-section-title text-foreground">邮件设置</h2>
            </div>
            <button
              onClick={fillQqMail}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-label text-muted-foreground mb-2">SMTP 服务器</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">SMTP 端口</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">授权码</label>
              <input
                type="password"
            ...
            <div>
              <label className="block text-label text-muted-foreground mb-2">发件人地址</label>
              <input
                type="email"
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <h3 className="text-subsection-title text-foreground mb-3">测试发信</h3>
