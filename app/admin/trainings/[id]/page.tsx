    ...
    return (
      <AdminLayout>
        <div className="py-12 text-center">
          ...
          <button
            onClick={fetchDetail}
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-br from-primary to-primary-dark text-white shadow-md hover:shadow-lg hover:from-primary-light hover:to-primary transition-all"
          >
      ...
      <div className="max-w-5xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Link
              href={`/training/${id}`}
              target="_blank"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
            >
            ...
            <button
              onClick={saveMeta}
              disabled={saving}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 text-sm font-medium rounded-lg bg-gradient-to-br from-primary to-primary-dark text-white shadow-md hover:shadow-lg hover:from-primary-light hover:to-primary transition-all disabled:opacity-50"
            >
        ...
        <div className="card-static p-6 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-muted/30 border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-colors"
              maxLength={100}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 bg-muted/30 border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-colors resize-y"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-muted/30 border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-primary/50"
              >
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-1.5 bg-muted/30 border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-primary/50"
                placeholder="输入标签后回车"
              />
              <button
                onClick={addTag}
        ...
        <div className="card-static p-6 space-y-4">
              ...
              {dirty.size > 0 && (
                <>
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-md text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
                  >
                    放弃
                  </button>
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-md bg-gradient-to-br from-primary to-primary-dark text-white shadow-sm hover:shadow hover:from-primary-light hover:to-primary transition-all disabled:opacity-50"
                  >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 text-sm font-medium rounded-lg bg-gradient-to-br from-primary to-primary-dark text-white shadow-md hover:shadow-lg hover:from-primary-light hover:to-primary transition-all"
          >
            <Plus className="w-4 h-4" />
                ...
                return (
                  <li
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 transition-colors ${
                      isDirty ? 'bg-warning/5' : 'hover:bg-muted/30'
                    }`}
                  >
                    ...
                    <div className="flex items-center gap-0.5 flex-shrink-0">
                      <button
                        ...
                        disabled={idx === 0}
                        className="p-1.5 rounded text-muted-foreground hover:text-foreground hover:bg-muted/50 disabled:opacity-30 disabled:cursor-not-allowed"
                        title="上移"
                      >
