  ...
  if (error) {
    return (
      <div className="py-12 text-center">
        ...
        <button onClick={fetchDetail} className="btn btn-primary inline-flex items-center gap-2">
    ...
    <AdminPageShell width="wide" className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          <Link
            ...
            className="btn-icon-sm -ml-1.5 hover:bg-muted text-muted-foreground hover:text-foreground transition-colors flex-shrink-0"
            aria-label="返回题单列表"
          >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <Link
            href={`/training/${id}`}
            target="_blank"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-label rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
          >
      ...
      <div className="card-static p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div>
            <label className="block text-label text-foreground mb-1.5">状态</label>
            <select
              value={status}
      ...
      <div className="card-static p-5 space-y-4">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <h2 className="text-section-title text-foreground">题目管理</h2>
            ...
            {dirty.size > 0 && (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1 btn btn-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
                >
                  放弃
                </button>
                <button
        ...
        {sortedProblems.length === 0 ? (
          <div
            className="py-12 text-center text-muted-foreground text-sm border rounded-lg"
            style={{ borderColor: 'var(--border)' }}
          >
            暂无题目，点击"添加题目"开始
          </div>
          ...
          <ul
            className="divide-y border rounded-lg bg-background/50"
            style={{ borderColor: 'var(--border)' }}
          >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span
                        className={`text-xs px-1.5 py-0.5 rounded border flex-shrink-0 ${difficultyClass(item.problem.difficulty)}`}
                      >
                  ...
                  <div className="flex items-center gap-0.5 flex-shrink-0">
                    <button
                      ...
                      disabled={idx === 0}
                      className="btn-icon-sm text-muted-foreground hover:text-foreground hover:bg-muted disabled:opacity-30 disabled:cursor-not-allowed"
                      title="上移"
                    >
                    ...
                    <button
                      ...
                      className="btn-icon-sm text-muted-foreground hover:text-error hover:bg-error/10"
                      title="移除"
                    >
