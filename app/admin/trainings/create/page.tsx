    ...
    <AdminLayout>
      <div className="max-w-5xl mx-auto space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-muted/30 border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-primary/50"
                placeholder="搜索题目名称..."
              />
            </div>
        ...
        <div className="flex items-center justify-end gap-2 pb-2">
          <Link
            href="/admin/trainings"
            className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
          >
            取消
          </Link>
          <button
            ...
            disabled={submitting}
            className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors disabled:opacity-50"
          >
            保存草稿
          </button>
          <button
            ...
            disabled={submitting}
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-br from-primary to-primary-dark text-white shadow-md hover:shadow-lg hover:from-primary-light hover:to-primary transition-all disabled:opacity-50"
          >
