    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="card-static rounded-2xl p-6 space-y-6">
            {error && (
            ...
            <div className="space-y-6">
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 card-static rounded-xl shadow-xl z-20 max-h-60 overflow-y-auto">
                    {searchResults.map(problem => (
                      <button
                        ...
                        className="w-full px-4 py-3 text-left hover:bg-muted/50 flex justify-between items-center border-b border-border last:border-0 transition-colors"
                      >
              ...
              <div className="space-y-2">
                {contestProblems.map((problem, index) => (
                  <div key={problem.id} className="flex items-center justify-between p-4 glass rounded-xl border border-border group hover:border-primary/30 transition-colors">
                    <div className="flex items-center gap-4">
                ...
                {contestProblems.length === 0 && (
                  <div className="text-center py-12 glass rounded-xl border-2 border-dashed border-border text-muted-foreground">
                    <p>暂无题目</p>
