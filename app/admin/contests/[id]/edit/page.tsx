          ...
          <div className="card-static rounded-2xl p-6 space-y-6">
                ...
                <div className="absolute top-full left-0 right-0 mt-2 card-static rounded-xl shadow-xl z-10">
                  {searchResults.map(problem => (
                    <button
                      ...
                      className="w-full px-4 py-3 text-left hover:bg-muted/50 flex justify-between items-center border-b border-border last:border-0"
                    >
            ...
            <div className="space-y-2">
              {contestProblems.map((problem, index) => (
                <div key={problem.id} className="flex items-center justify-between p-4 glass rounded-xl border border-border">
