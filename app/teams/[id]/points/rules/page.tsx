      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="card-static rounded-2xl p-6">
            ...
            <div className="space-y-4">
              {[
                { q: '积分会过期吗？', a: '目前积分不会过期，但团队管理员可能会在学期结束时清零积分，具体以团队公告为准。' },
                ...
                { q: '积分被误扣怎么办？', a: '请联系团队管理员或教师，说明情况。管理员可以手动补发积分。' }
              ].map((item, idx) => (
          ...
          <div className="card-static rounded-2xl p-6 bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20">
            ...
            <div className="flex gap-3 flex-wrap">
              <Link
                href={`/teams/${teamId}/assignments`}
                className="btn btn-primary"
              >
                去做作业
              </Link>
              <Link
                href={`/teams/${teamId}/notes`}
