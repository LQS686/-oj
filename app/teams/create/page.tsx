...
export default function CreateTeamPage() {
  ...
  useEffect(() => {
    if (user && !canCreateTeam(user)) {
      toast.error('权限不足：只有教师和管理员可以创建团队')
      router.push('/teams')
    }
  }, [user, router])
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">登录后即可创建团队</p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">只有教师和管理员可以创建团队</p>
        ...
        <div className="card-static rounded-2xl p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">建立你的学习团队，与伙伴一起进步</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="font-medium text-foreground">公开团队</div>
                    {formData.isPublic && (
                      <Check className="w-5 h-5 text-primary ml-auto" />
                    )}
                  </div>
                  <p className="text-sm text-muted-foreground">
                    公开团队会在团队列表中展示，其他用户可以申请加入
                  </p>
                </button>
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="font-medium text-foreground">私有团队</div>
                    {!formData.isPublic && (
                      <Check className="w-5 h-5 text-primary ml-auto" />
                    )}
                  </div>
                  <p className="text-sm text-muted-foreground">
                    私有团队不会在列表中显示，只能通过邀请加入
                  </p>
                </button>
              </div>
            </div>
            ...
            <div className="card-static rounded-xl p-5 border border-primary/20 bg-primary/5">
              ...
              <ul className="text-sm text-muted-foreground space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  创建团队后，你将自动成为团队所有者（Owner）
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-light mt-0.5">•</span>
                  你可以邀请其他用户加入团队，并设置管理员
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary-light mt-0.5">•</span>
                  团队名称在全站范围内必须唯一
