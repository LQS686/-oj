        ...
        {showSkeleton ? (
          <div className="card-static overflow-hidden">
            ...
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="flex items-center border-b border-border/50 px-4 py-3 animate-pulse"
              >
                ...
                <div className="w-24 text-right">
                  <div className="h-5 w-12 rounded bg-muted ml-auto" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="animate-fadeIn">
            {error && (
              <div className="card-static p-4 mb-6 border border-error/30 bg-error/5">
            ...
            <div className="card-static rounded-t-lg flex px-4 py-3 text-sm font-semibold text-muted-foreground border-b border-border/50">
              <div className="w-16 text-center">排名</div>
              <div className="flex-1">选手</div>
              <div className="w-24 text-right">解题数</div>
            </div>
            ...
            <div
              ref={containerRef}
              className="flex-1 card-static rounded-b-lg overflow-y-auto custom-scrollbar max-h-[calc(100vh-14rem)]"
            >
              {rankings.map((user) => {
              ...
              {!hasMore && rankings.length > 0 && (
                <div className="text-center py-6 text-muted-foreground text-sm">已加载全部数据</div>
              )}
            </div>
