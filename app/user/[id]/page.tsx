    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <motion.div 
          ...
          className="card-static rounded-3xl p-14 text-center max-w-md border border-error/10"
        >
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        >
          <div className="lg:col-span-1 space-y-7">
            <motion.div variants={itemVariants} className="card-static rounded-3xl p-8 border border-primary/5">
              <div className="text-center">
                <div 
                  className="w-28 h-28 rounded-3xl mx-auto mb-6 flex items-center justify-center text-white text-4xl font-bold overflow-hidden shadow-xl"
            ...
            <motion.div variants={itemVariants} className="card-static rounded-3xl p-8 border border-primary/5">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-2xl bg-muted/25 hover:bg-muted/40 transition-all">
            ...
            <motion.div variants={itemVariants} className="card-static rounded-3xl p-8 border border-accent/5">
              ...
              <div className="grid grid-cols-3 gap-4">
                {['🏆', '🥇', '🥈', '🥉', '⭐', '🎯'].map((emoji, index) => (
                  <div 
                    key={index} 
                    className="aspect-square bg-muted/25 rounded-2xl flex items-center justify-center text-4xl hover:bg-muted/40 transition-all cursor-pointer group relative"
                  >
                    {emoji}
          ...
          <div className="lg:col-span-2 space-y-7">
            ...
            <motion.div variants={itemVariants} className="card-static rounded-3xl p-8 border border-secondary/5">
              <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-foreground">
                      ...
                      <tr>
                        <td colSpan={4} className="px-5 py-16 text-center">
                          <div className="flex flex-col items-center gap-4">
                            <div className="w-14 h-14 rounded-2xl bg-muted/25 flex items-center justify-center">
