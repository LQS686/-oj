...
export const unauthorized = (message = '未登录') => fail('UNAUTHORIZED', message, 401)

export const forbidden = (message = '权限不足') => fail('FORBIDDEN', message, 403)

export const notFound = (message = '资源不存在') => fail('NOT_FOUND', message, 404)

export const badRequest = (message = '参数错误') => fail('BAD_REQUEST', message, 400)

export const conflict = (message = '资源冲突') => fail('CONFLICT', message, 409)

export const serverError = (message = '服务器错误') => fail('SERVER_ERROR', message, 500)
