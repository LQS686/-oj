    ...
    <div className="space-y-8 relative">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="group">
                    ...
                    <div className="relative">
                      <pre className="bg-muted/50 p-4 rounded-xl border border-border text-sm font-mono whitespace-pre-wrap break-all text-foreground overflow-x-auto group-hover:border-primary/30 transition-colors duration-300">
                        {sample.input}
                      </pre>
                      <button
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <pre className="bg-muted/50 p-4 rounded-xl border border-border text-sm font-mono whitespace-pre-wrap break-all text-foreground overflow-x-auto group-hover:border-secondary/30 transition-colors duration-300">
                        {sample.output}
                      </pre>
                      <button
      ...
      {problem.hint && (
        <section className="animate-fadeIn">
          ...
          <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border-l-4 border-primary p-5 rounded-xl animate-fadeIn">
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-primary/80 hover:bg-primary transition-colors duration-300 flex items-center justify-center shadow-lg shadow-primary/30 z-10"
        aria-label="回到顶部"
      >
