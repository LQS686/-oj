    ...
    return (
      <>
        ...
        <Link href="/register" className="btn-primary btn group">
          <span className="hidden sm:inline group-hover:scale-105 transition-transform duration-300">免费注册</span>
          <span className="sm:hidden group-hover:scale-105 transition-transform duration-300">注册</span>
        </Link>
      </>
    )
  }
  ...
  return (
    <>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 badge-primary badge min-w-[18px] h-[18px] text-[10px] animate-pulse-slow">
      ...
      <Dropdown 
        trigger={
          ...
          >
            {user.avatar ? (
              <div className="avatar avatar-md border-2 border-primary/30 group-hover:border-primary group-hover:scale-110 transition-all duration-300">
                <Image 
                  src={user.avatar} 
                  alt="Avatar" 
                  width={40} 
              ...
              <div className="avatar avatar-md group-hover:scale-110 transition-transform duration-300">
      ...
      >
        <div className="min-w-[200px]">
          {canAccessAdminUser && (
            ...
            >
              <Settings className="w-[18px] h-[18px] transition-transform duration-300 group-hover:rotate-3" />
              后台管理
            </Link>
          )}
          <Link
          ...
          >
            <User className="w-[18px] h-[18px] transition-transform duration-300 group-hover:rotate-3" />
            个人主页
          </Link>
          {isAdminUser && (
            <Link
              ...
              className="dropdown-item group"
            >
              <ListChecks className="w-[18px] h-[18px] transition-transform duration-300 group-hover:rotate-3" />
              提交记录
            </Link>
          )}
          <Link
          ...
          >
            <LogOut className="w-[18px] h-[18px] transition-transform duration-300 group-hover:rotate-3" />
            退出登录
          </button>
        </div>
      </Dropdown>
