                ...
                return (
                  <button
                    ...
                    className={`w-full px-4 py-2.5 text-left transition-colors ${
                      isActive ? 'bg-primary/5 border-l-2 border-primary' : 'hover:bg-muted/40 border-l-2 border-transparent'
                    }`}
                  >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/30 text-left border-b border-border">
                <th className="px-3 py-2.5 font-medium text-muted-foreground sticky left-0 bg-muted/30 z-[1] w-[110px]">
                  学生
                </th>
                  ...
                  <td className="px-3 py-2.5 sticky left-0 bg-background z-[1]">
                    <div className="flex items-center gap-2 min-w-0">
                      {student.avatar ? (
                        ...
                        <div className="w-6 h-6 rounded-full shrink-0 bg-gradient-to-br from-primary to-secondary flex items-center justify-center">
                    ...
                    <td
                      ...
                      className={`px-3 py-2.5 text-center align-middle ${
                        student.submissions[problem.id]
                          ...
                          : onProblemClick ? 'cursor-pointer hover:bg-muted/30 transition-colors' : ''
                      }`}
                    >
