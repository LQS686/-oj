...
export default function JudgeStatus({
  ...
  return (
    <div
      ...
      role="status"
      aria-live={isJudging ? 'polite' : 'assertive'}
    >
      <div className={`px-6 py-4 border-b ${getStatusColor(status)}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className={`font-bold ${getStatusTextColor(status)}`}>
      ...
      <div className="px-6 py-4">
        ...
        <div
          ...
          aria-valuemin={0}
          aria-valuemax={100}
          aria-label={`评测进度: ${Math.round(progress)}%`}
        >
          <div
      ...
      {testResults.length > 0 && (
        <div className="px-6 pb-4">
          <div className="text-subsection-title text-foreground mb-3">测试点详情</div>
