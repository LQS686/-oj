...
export default function JudgeStatus({
  ...
  return (
    <div className="card-static rounded-2xl overflow-hidden" role="status" aria-live={isJudging ? "polite" : "assertive"}>
        ...
        <div className="flex items-center justify-between">
          ...
          {onClose && !isJudging && (
            <button
              ...
              className="p-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary"
              aria-label="关闭"
            >
              <X className="w-5 h-5" />
            </button>
